-- 새로운 Location 삽입
INSERT INTO seurasaeng_prod.location (location_id, location_name, latitude, longitude) VALUES
...
-- 새로운 Shuttle 삽입
INSERT INTO seurasaeng_prod.shuttle (shuttle_id, shuttle_name, departure, destination, is_commute) VALUES
(1, '정부과천청사', 1, 6, true),
(2, '양재', 2, 6, true),
(3, '사당', 3, 6, true),
(4, '이수', 4, 6, true),
